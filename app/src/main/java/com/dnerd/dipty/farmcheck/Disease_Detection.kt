...
import com.dnerd.dipty.farmcheck.tensorflow.Classifier
import com.dnerd.dipty.farmcheck.tensorflow.TensorFlowImageClassifier
...
import com.dnerd.dipty.farmcheck.R.id.*
import com.wonderkiln.camerakit.CameraKitImage
import kotlinx.coroutines.experimental.Job
import kotlinx.coroutines.experimental.launch

import kotlinx.android.synthetic.main.activity_disease__detection.*


 class Disease_Detection : AppCompatActivity() {
    companion object {
        private const val TAG = "Disease_Detection"
        ...
        private const val MODEL_FILE = "file:///android_asset/retrained_graph.pb"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_disease__detection)
        //Toast(this)

        initializeTensorClassifier()
        /*val buttonRecognize = findViewById<Button>(R.id.buttonRecognize)*/
